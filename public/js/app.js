...
function initAdmin() {
  ...
  function renderItems(items) {
    ...
    return parsedItems.map(function (menuItems) {
      return "\n            <p>".concat(menuItems.item.name, " - ").concat(menuItems.qty, " pcs</p>\n            ");
    }).join('');
  }
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkpizza_ordering_website"] = self["webpackChunkpizza_ordering_website"] || [];
